...
dimensions=("Dynamic_Attribute" "Dynamic_Spatial_Relationship" "Motion_Order_Understanding" "Complex_Plot")

# Corresponding folder names
folders=("Dynamic_Attribute" "Dynamic_Spatial_Relationship" "Motion_Order_Understanding" "Complex_Plot")

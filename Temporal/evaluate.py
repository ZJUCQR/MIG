...
def parse_args():
    ...
    parser.add_argument(
        "--mode",
        choices=['custom_input', 'vbench_standard', 'vbench_category', 'temporal_sequence'],
        ...
        4. "temporal_sequence": evaluate ordered image sequences under temporal_results/<id>/
        """,
    )
    parser.add_argument(
        "--prompt",
    ...
    parser.add_argument(
        ...
        type=str,
        default=f'{CUR_DIR}/temporal_prompts.json',
        help="path to temporal_prompts.json used in temporal_sequence mode",
    )
...
def main():
    ...
    if args.mode == 'temporal_sequence':
        kwargs['temporal_prompt_file'] = args.temporal_prompt_file

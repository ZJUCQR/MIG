...
NEGATIVE_PROMPT_DEFAULT = os.getenv("NEGATIVE_PROMPT", " ")
...
def load_pipeline(weight_dtype: torch.dtype) -> Tuple[QwenImageEditPlusPipeline, torch.device]:
    device = _get_device()
    model_path = os.getenv("MODEL_PATH", "/gemini/platform/public/aigc/zhuangcailin/pretrain/Qwen/Qwen-Image-Edit-2509")
